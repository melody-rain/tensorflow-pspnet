...
def get_network_fn(name, num_classes, weight_decay=0.0, is_training=False, not_freeze_bn=False):
    ...
    def network_fn(images):
        with slim.arg_scope(arg_scope):
            return func(images, num_classes, is_training=is_training, not_freeze_bn=not_freeze_bn)
